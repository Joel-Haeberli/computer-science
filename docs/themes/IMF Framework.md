...
- MOCs are not hierarchical like a table of contents. They are [heterarchial](https://en.wikipedia.org/wiki/Heterarchy). Meaning, you can have multiple maps organizing the same info in different ways to fit whatever perspective the note is for.
